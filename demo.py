...
import test
import valid
from cenet_model_xr import CENET
...
def main_portal(args):
    ...
    train_s_neighbor_f = '/train_s_neighbor.txt'
    train_o_neighbor_f = '/train_o_neighbor.txt'
    ...
    dev_s_neighbor_f = '/dev_s_neighbor.txt'
    dev_o_neighbor_f = '/dev_o_neighbor.txt'
    ...
    test_s_neighbor_f = '/test_s_neighbor.txt'
    test_o_neighbor_f = '/test_o_neighbor.txt'
    ...
    with open('./data/' + args.dataset + train_s_neighbor_f, 'rb') as f:
        train_s_history_oids, train_s_last_event = pickle.load(f)
    with open('./data/' + args.dataset + train_o_neighbor_f, 'rb') as f:
        train_o_history_oids, train_o_last_event = pickle.load(f)
    ...
    with open('./data/' + args.dataset + test_s_neighbor_f, 'rb') as f:
        test_s_history_oids, test_s_last_event = pickle.load(f)
    with open('./data/' + args.dataset + test_o_neighbor_f, 'rb') as f:
        test_o_history_oids, test_o_last_event = pickle.load(f)
    ...
    if args.dataset != 'ICEWS14':
        ...
        with open('./data/' + args.dataset + dev_s_neighbor_f, 'rb') as f:
            dev_s_history_oids, dev_s_last_event = pickle.load(f)
        with open('./data/' + args.dataset + dev_o_neighbor_f, 'rb') as f:
            dev_o_history_oids, dev_o_last_event = pickle.load(f)
    ...
    if not args.only_eva and not args.only_oracle:
        ...
        while epoch < args.max_epochs:
            ...
            for batch_data in utils.make_batch(train_data,
                                               ...
                                               train_s_frequency,
                                               train_o_frequency,
                                               train_s_history_oids,
                                               train_o_history_oids,
                                               train_s_last_event,
                                               train_o_last_event,
                                               args.batch_size):
            ...
            if  (epoch % args.valid_epochs == 0 or epoch==args.max_epochs) and args.dataset != 'ICEWS14T':
                ...
                draw_losses.append(loss_epoch)
                draw_metrix.append(oracle_all_mrr_lk)
                file_validation.write("\n-------------------------------------\n")
    ...
    s_ranks1, o_ranks1, all_ranks1, s_ranks2, o_ranks2, all_ranks2, s_ranks3, o_ranks3, all_ranks3 \
        = test.execute_test(args, total_data,
                             model, test_data,
                             test_s_label,
                             test_o_label,
                             test_s_frequency,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--description", type=str, default='DEMO', help="description")
    parser.add_argument("-d", "--dataset", type=str, default='DEMO', help="dataset")
    ...
    parser.add_argument("--model_dir", type=str, default="yago27-05-2025,00-27-34YAGO-EPOCH30/", help="model directory")
